...
#methaneSensor = go.Scatter(x=xAxis, y=mq4Data, name='MQ4 CH4 Sensor (ppm)')
altSensor = go.Scatter(x=xA, y=altData, name='Altimeter (ft)')

data = [gasSensor, ozoneSensor, altSensor]
